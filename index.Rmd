...
1. Binary classification problems ROC curves:
    ...
    + Contingency tables for a given threshold $p^*$
    + Based on contingency table for a given threshold $p^*$, we need a score for [Sensitivity and Specificity](https://en.wikipedia.org/wiki/Sensitivity_and_specificity){target="_blank"}
