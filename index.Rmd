...
1. The last two weeks will be a "book club" of [Deep Learning Illustrated](https://www.deeplearningillustrated.com/){target="_blank"}. Please see [Lec24](#Lec24) for how to obtain free access to the eBook. Before being thrown into a massive task, I always find it helpful to set some goals and define a purpose. This helps me stay focused and not get lost in the weeds.
    1. **Micro goal of book club**: Understand to what researchers mean when they say deep learning is a ["black box"](Safiya Noble){target="_blank"} where nobody really understands how these algorithms work. Prof. Safiya Umoja Noble stated in the podcast on "Algorithms of Oppression" from [Lec18](#Lec18) that this lack of interpretability will be problematic for society as more of our lives becomes dependent on such algorithms.
