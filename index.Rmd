...
[HTML Solutions](static/MP4_solutions.html){target="_blank"} to MP4 posted (`.Rmd` source code available [here](MP.html#MP4-solutions)). Things to note:

1. Figure 1: Plot of $y$ = estimated accuracy over $x$ = $\alpha$ complexity parameter
    * Why does it look like steps and not a smooth curve like with MSE vs complexity?
