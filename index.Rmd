...
1. How do I interpret trees? Binary splits on:
    + Numerical predictors
    + Categorical predictors that have been *one-hot encoded*. Note: many statistical software packages will do this automatically for you.  
    ![](static/images/One-Hot_Encoding_web.png){ width=50% }
1. Works for both types of outcomes $y$



**Second:** Based on `CART.Rmd` Shiny app. (Note: after you install the necessary packages, this should knit.) 
