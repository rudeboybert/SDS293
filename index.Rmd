...
* Check out [Machine Learning Flashcards](https://gumroad.com/l/machinelearningflashcards){target="_blank"} posted on Slack in `#general`


## Topics

* Tie in Tree with Lec01 slides -> Slide 20. Complexity vs fit.
* Explain $p_{mk}$ notation.
