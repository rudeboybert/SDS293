...
1. ROC curves:
    + [Sensitivity and Specificity](https://en.wikipedia.org/wiki/Sensitivity_and_specificity){target="_blank"}
    + Decision rule for $\widehat{y}$ based on $\widehat{p}$
    + [Parametric curve/equation](https://en.wikipedia.org/wiki/Parametric_equation){target="_blank"}
