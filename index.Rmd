...
1. Note that conveying all the theory is very difficult without doing an actual "chalk talk." So please try to focus on the ideas in a general and qualitative sense and not get bogged down in the details:
    ...
    1. "Eigen" is German for "its own." In this case an **eigenvalue** is a number telling you how much variance there is in the data along a particular dimension. The particular dimension for an particular eigenvalue is the **eigenvector**.
