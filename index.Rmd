...
* post solutions to last exercises
...
The iris dataset is a cannonical dataset in statistics and machine learning ([Wikipedia](https://en.wikipedia.org/wiki/Iris_flower_data_set)). Introduced by Fisher in 1936 paper "The use of multiple measurements in taxonomic problems as an example of linear discriminant analysis." For 150 iris flowers it has
...
<center><img src="static/images/petals_sepals.jpg" alt="Drawing" style="width: 200px;"/></center>
