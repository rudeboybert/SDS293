...
<center>
![](static/other/bailey.png){ width=700px }
</center>
...
![](static/images/validation_set.png){ width=700px }

**Image 2: k = 5 fold crossvalidation**:
![](static/images/k-fold-CV.png){ width=700px }

**Image 3: Leave-one-out crossvalidation (LOOCV)**:
![](static/images/LOOCV.png){ width=700px }
