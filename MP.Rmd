...
# Mini-project 5 (STILL A WORK IN PROGRESS) {#MP5}
...
* **Group leader only**: Submit a `MP5_Group_XX.zip` archive file with the contents of your `MP5` RStudio Project folder **but not the data files! They are huge!** You can assume I have them.
* **Both group members**: Complete the following peer evaluation **and exit survey for the course** [Google Form](https://docs.google.com/forms/d/e/1FAIpQLSdlJyS-jGry0_nelwgjHJQ14Pu-gCIFao2rTLXFMVtvi04zhg/viewform){target="_blank"}. Both group members must complete the Google Form to receive full credit.
