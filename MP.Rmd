...
1. **Point of diminishing returns:** Grade: 9.5/10.
    ...
    + Fit a regression model $\widehat{f}_{3}$ choosing your predictor variables in a non-arbitrary fashion using a method in Chapter 6.1 of the ISLR textbook.
