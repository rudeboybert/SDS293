...
1. **Reaching for the stars:** Grade: 9.5/10. 
    + Satisfy all "baseline", "minimally viable product", and "due diligence" criteria.
    + Reusing the MP1 solutions code, for the range of `alpha` complexity parameters in the `alpha_df` data frame, return an estimate of the accuracy that Kaggle would return.
